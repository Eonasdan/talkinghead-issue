...
class LipsyncEn {
    /**
     * @typedef {Object} LipsyncEnMethods
     
     * @property {function(s: string): string} preProcessText - Preprocesses a text string, converting symbols and numbers to words, and filtering unnecessary characters.
     *
     * @property {function(w: string): Object} wordsToVisemes - Converts a word into Oculus LipSync visemes, durations, times, and other related properties.
     */
  ...
  * @param {string} s Text
  * @return {string} Preprocesssed text.
  */
  preProcessText(s) {
